...
In the study, test subjects performed a dumbell lifting excercise.  The excercise was performed:
Class A: Exactly according to specification
Class B: Throwing elbows in front
Class C: Lifting dumbell halfway
Class D: Lowering the dumbell halway
Class E: Throwing the hips to the front

Class A represents properly execution.  The other four classes are mistakes.
...
# Verify that the column names match between the two data sets.
...
Get rid of any static data that will not impact the results. 
...
```
All of the data that has no variance is false.  Since it is all false, it will not impact the assignment.
...
After doing some research on the assignment online, I am going to do what has been done in the past.  I am going to try calssifcation trees.
...
## Balanced Accuracy      0.7866   0.6475   0.7605  0.59955   0.7926
```
Cross validating the data didn't seem to make much of a difference.  Even after doing research I'm not sure I did that right.
...
## Levels: A B C D E
```
Again, preprocessing didn't make much of a difference.  
...
I'm going to go over this again.  Still not sure on this assignment.

Error rates after running the predict() function on the 4 testing sets:
...
1. Accuracy Rate 0.0286 Predictions: A A B A A B E D A A A C B A E B B E A B
2. Accuracy Rates 0.0366 and 0.0345 Predictions: A A A B B D E E E A B B B C B A A B A C
3. Accuracy Rate 0.0437 Predictions: A E A B B B E D B A A B A D A A D D B C
